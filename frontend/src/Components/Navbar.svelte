<script>
    ...
    <nav class="items-center bg-black ">
        <div class="flex items-center justify-between mx-auto border-2 border-white">
            <div class="flex items-center p-4 hover:fill-slate-600 fill-red-400 ">
            <a href="/">
                <button class="flex space-x-3 fill-pink ">
                    ...
                    <h1 class="text-4xl font-bold text-blue-400 font-avarabold">
                        No_Name
                    </h1>
                </button>
            </a>
            ...
            <div class="flex pr-6 space-x-6 text-xl font-avarabold text-white  items-center ">
                ...
                {#if darkmode==true}
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6 hover:fill-yellow-400">
                ...
                {:else}
                     <button on:click={()=>(darkmode= !darkmode)}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="purple" class="w-6 h-6 hover:fill-white">
